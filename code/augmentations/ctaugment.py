...
# Optional backwards‐compatibility block at top of file:
try:
...
def rescale(x, scale, method):
    ...
    chosen = methods[int(method * 5.99)]
    # explicitly name the resample argument
    return x.crop(crop).resize(x.size, resample=chosen)
